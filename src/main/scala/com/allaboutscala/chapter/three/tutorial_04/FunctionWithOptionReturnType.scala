package com.allaboutscala.chapter.three.tutorial_04

/**
  * Created by rogier.verkaik on 21-9-2016.
  */
object FunctionWithOptionReturnType extends App {

  println("Step 1: Define a function which returns an Option of type String")
  ...
  dailyCouponCode() match {
    ...
    case None => println("Sorry there is no coupon code today!")
  }
  ...
  println(s"Today's coupone code = $todayCouponUsingFold")
}
